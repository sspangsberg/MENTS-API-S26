 ...
 *     tags:
 *       - Product Routes
 *     summary: Search for products based on query
 *     description: Retrieves an array of products based on a query in the body
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 *           example:
 *             key: "name"
 *             value: "The best and precious statue ever"
 *     responses:
 *       200:
 ...
 */
router.post('/products/query', getProductsByQueryGeneric);
